...
def usage():
	print '---------------------------------------------------'
	print 'ATTACKER DEAD KILLER'
	print 'KALI LINUX XPLOIT'
	print 'BAWA KELEM'
	print 'To use windows : CDS1.py <url> '
	print 'To use Linux   : python2 CDS1.py <url> '
	print "\a"
...
/_/  /_/_/  (_)_____/_/_/\___/_/ /_/
  ...
  ==========<<NO SYSTEM IS SAFE>>==========
      ...
      BUAT APA DENGAN PUKULAN
         JIKA KETIKAN SAJA
      BIASA MEMBUAT MERUGIKAN
"""
print '---------------------------------------------------'
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print '=> THE ATTACK OF CYBER DARK SISTEM PENYERANGAN DI LAKSANAKAN '
 			print ':) MR.ELLEN ===='
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "PENYERANGAN DI MULAI FULL POWER MR.ELLEN"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]

...
def usage():
	print '---------------------------------------------------'
	print 'CARA : python2 CDS2.py <url>'
	print 'Mr.Ellen : Jangan Putus Assa'
	print "\a"
print \
"""
    _  _____ _____  _    ____ _  _______ ____      [CYBER]
   / \|_   _|_   _|/ \  / ___| |/ / ____|  _ \       [DARK]
  / _ \ | |   | | / _ \| |   | ' /|  _| | |_) |     [SISTEM]
 / ___ \| |   | |/ ___ \ |___| . \| |___|  _ <
/_/   \_\_|   |_/_/   \_\____|_|\_\_____|_| \_\

         ___________[CDS]___________
         |TEAM CYBER DARK SISTEM |
         [][][][][][][][][][][][][][]
"""
print '---------------------------------------------------'
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
 			print '<<>> PENYERANGAN SEDANG DI PROSES ! <<>>'
			code=500
